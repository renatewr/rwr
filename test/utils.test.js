...
describe('utils.attributeToArray()', function(){
...
describe('utils.removeClass foo if an element has class foo', function(){

    it('should remove class foo', function(done){
        const result = '<div id="root"><a class="slides"></a><a class="slides"></a><a class="slides"></a></div>';

        jsdom.env('<div id="root"><a class="slides"></a><a class="slides"></a><a class="foo slides"></a></div>', function(error, window){
...
describe('utils.addClass foo if an element does not have class foo', function(){

    it('should remove class foo', function(done){
        const result = '<div id="root"><a class="slides foo"></a><a class="slides foo"></a></div>';

        jsdom.env('<div id="root"><a class="slides"></a><a class="slides"></a></div>', function(error, window){
...
describe('utils.comscoreParams()', function () {
    let aObj,bObj;

    before(function(){
        aObj= utils.comscoreParams("classified", "ba");
        bObj= utils.comscoreParams();
    });

    it('should include classified in a_click_area', function(){
        assert.equal("classified", aObj.a_click_area);
    });

    it('should have property a_click_area ', function(){
        expect(aObj).to.have.property('a_click_area', 'classified');
    });

    it('should not have property a_click_area ', function(){
        expect(bObj).to.have.property('a_click_area', undefined);
    });

    it('should not include classified in a_click_area', function(){
        assert.notEqual("classified", bObj.a_click_area);
    });
});

describe('utils.extractDate', function() {
...
describe('Returning the corresponding value based on attribute name in json object', function() {

    describe('Period formatted', function () {
        it('returns 1.999.999 if value is 1999999', function () {
    ...
    describe('Shortening a textstring', function (){
        it('returns the full string if it is 120 characters or less', function() {
        ...
        it('returns the first 117 characters plus ...', function() {
...
describe('jsonFromUrl', function() {
    ...
    it('should allow empty parameters', function(){
        const expected = { };
    ...
    it('should allow single nested objects', function(){
        const expected = {
            foo: {
                bar: 'baz'
            }
    ...
    it('should allow missing question mark', function(){
        const expected = { };
...
describe('areEqualIgnoreCase', function() {
